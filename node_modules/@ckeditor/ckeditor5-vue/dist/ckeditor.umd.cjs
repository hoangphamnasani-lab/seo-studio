(function(global, factory) {
  ...
  function isRootsMapConfigurationSupported() {
    const bundleInfo = ckeditor5IntegrationsCommon.getCKBaseBundleInstallationInfo();
    if (!bundleInfo) {
      return false;
    }
    return !ckeditor5IntegrationsCommon.isSemanticVersion(bundleInfo.version) || ckeditor5IntegrationsCommon.isCKTestingVersion(bundleInfo.version) || ckeditor5IntegrationsCommon.destructureSemanticVersion(bundleInfo.version).major >= 48;
  }
