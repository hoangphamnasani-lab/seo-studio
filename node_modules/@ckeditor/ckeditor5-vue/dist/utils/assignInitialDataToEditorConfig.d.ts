 ...
 */
export declare function assignInitialDataToEditorConfig(config: Record<string, any>, data: string): EditorConfig;
/**
 * Retrieves the initial data from the editor configuration object, depending on the loaded CKEditor version.
 */
export declare function getInitialDataFromEditorConfig(config: Record<string, any>): string | undefined;
/**
