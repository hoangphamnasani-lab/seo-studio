...
import { DataFilter } from '@ckeditor/ckeditor5-html-support/dist/datafilter.js';
import { CodeBlockElementSupport } from '@ckeditor/ckeditor5-html-support/dist/integrations/codeblock.js';
import { DualContentModelElementSupport } from '@ckeditor/ckeditor5-html-support/dist/integrations/dualcontent.js';
import { HeadingElementSupport } from '@ckeditor/ckeditor5-html-support/dist/integrations/heading.js';
import { ImageElementSupport } from '@ckeditor/ckeditor5-html-support/dist/integrations/image.js';
import { MediaEmbedElementSupport } from '@ckeditor/ckeditor5-html-support/dist/integrations/mediaembed.js';
import { ScriptElementSupport } from '@ckeditor/ckeditor5-html-support/dist/integrations/script.js';
import { TableElementSupport } from '@ckeditor/ckeditor5-html-support/dist/integrations/table.js';
import { StyleElementSupport } from '@ckeditor/ckeditor5-html-support/dist/integrations/style.js';
import { ListElementSupport } from '@ckeditor/ckeditor5-html-support/dist/integrations/list.js';
import { HorizontalLineElementSupport } from '@ckeditor/ckeditor5-html-support/dist/integrations/horizontalline.js';
import { IframeElementSupport } from '@ckeditor/ckeditor5-html-support/dist/integrations/iframe.js';
import { CustomElementSupport } from '@ckeditor/ckeditor5-html-support/dist/integrations/customelement.js';
